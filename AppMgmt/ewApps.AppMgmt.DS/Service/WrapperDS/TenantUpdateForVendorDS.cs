...
namespace ewApps.AppMgmt.DS {
  public class TenantUpdateForVendorDS:ITenantUpdateForVendorDS {
    ...
    ILogger<TenantUpdateForVendorDS> _loggerService;

    public TenantUpdateForVendorDS(IUserSessionManager userSessionManager, ITenantUserDS tenantUserDS,
           IUserTenantLinkingDS userTenantLinkingDS, ITenantUserAppLinkingDS tenantUserAppLinkingDS,
           IIdentityServerDS identityServerDS, IUnitOfWork unitOfWork, ILogger<TenantUpdateForVendorDS> loggerService) {
    ...
    public async Task<TenantUserSignUpResponseDTO> SignUpVendorUserAsync(TenantUserSignUpDTO tenantUserSignUpDTO, CancellationToken token = default(CancellationToken)) {
      ...
      int userType = (int)UserTypeEnum.Vendor;
    ...
    public async Task<TenantUserSignUpResponseDTO> UpdateVendorTenantUser(TenantUserSignUpDTO tenantUserSignUpDTO) {
