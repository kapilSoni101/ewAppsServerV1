...
namespace ewApps.AppMgmt.DS {
    public class TenantUserUpdateForBusinessDS :ITenantUserUpdateForBusinessDS {
        ...
        public TenantUserUpdateForBusinessDS(IUserSessionManager userSessionManager, ITenantUserDS tenantUserDS, IIdentityServerDS identityServerDS,
        ...
        public async Task<UpdateTenantUserResponseDTO> UpdateUserAsync(TenantUserUpdateRequestDTO tenantUserUpdateRequestDTO) {
            ...
            int userType = (int)UserTypeEnum.Business;
            ...
            if(tenantUser != null) {
                ...
                foreach(UserAppRelationDTO deleteApp in deleteAppList) {
                    TenantUserAppLinking tenantUserAppLinking = await _tenantUserAppLinkingDS.FindAsync(ut => ut.TenantUserId == tenantUser.ID && ut.TenantId == tenantUserUpdateRequestDTO.TenantId && ut.AppId == deleteApp.AppId && ut.Deleted == false);
                    if(tenantUserAppLinking == null) {
                ...
                foreach(UserAppRelationDTO updateApp in updateAppList) {
                    ...
                    // Get user applinking.
                    TenantUserAppLinking tenantUserAppLinking = await _tenantUserAppLinkingDS.FindAsync(tu => tu.AppId == updateApp.AppId && tu.TenantId == tenantUserUpdateRequestDTO.TenantId && tu.TenantUserId == tenantUser.ID && tu.Deleted == false);
                    ...
                    if(tenantUserAppLinking != null) {
                        ...
                        if(tenantUserAppLinking.Active != updateApp.Active) {
                            ...
                            if(updateApp.Active) {
                                //Task markUserActive = _identityServerDS.MarkActiveInActiveOnIdentityServerAsync(updateApp.Active, tenantUser.IdentityUserId, tenantUserUpdateRequestDTO.TenantId);
