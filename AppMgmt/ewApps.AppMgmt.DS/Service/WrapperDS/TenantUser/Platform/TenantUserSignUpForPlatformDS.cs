...
namespace ewApps.AppMgmt.DS {
    ...
    /// </summary>
    public class TenantUserSignUpForPlatformDS :ITenantUserSignUpForPlatformDS {
        ...
        ILogger<TenantUserSignUpForPlatformDS> _loggerService;
        ...
        /// </summary>
        public TenantUserSignUpForPlatformDS(ITenantUserDS tenantUserDS, IUserTenantLinkingDS userTenantLinkingDS, IIdentityServerDS identityServerDS, IUnitOfWork unitOfWork,
            IUserSessionManager userSessionManager, IAppDS appDS , ITenantUserAppLinkingDS tenantUserAppLinkingDS, ILogger<TenantUserSignUpForPlatformDS> loggerService) {
        ...
        public async Task<TenantUserSignUpResponseDTO> SignUpUserAsync(TenantUserSignUpDTO tenantUserSignUpDTO, CancellationToken cancellationToken = default(CancellationToken)) {
            ...
            int userType = (int)UserTypeEnum.Platform;
            ...
            try {
                App platApp = await _appDS.GetAppByAppKeyAsync(AppKeyEnum.plat.ToString(), cancellationToken);
                ...
                if(userTenantLinking == null) {
                    ...
                    string appKeys = AppKeyEnum.plat.ToString();
                    ...
                    TenantUserAppLinking tenantUserAppLinking = await _tenantUserAppLinkingDS.FindAsync(ut => ut.TenantUserId == tenantUser.ID && ut.AppId == platApp.ID && ut.TenantId == tenantUserSignUpDTO.TenantId && ut.Deleted == false);
                    if(tenantUserAppLinking == null) {
                        tenantUserAppLinking = new TenantUserAppLinking();
                        tenantUserAppLinking.Deleted = false;
                        tenantUserAppLinking.AppId = platApp.ID;
                    ...
                    ThrowDuplicateEmailError(tenantUserSignUpDTO.Email, platApp.Name);
                }
                ...
                userAppRelationDTO.AppId = platApp.ID;
                userAppRelationDTO.AppKey = platApp.AppKey;
