...
namespace ewApps.AppMgmt.DS {
    public class TenantUserDeleteForPublisherDS:ITenantUserDeleteForPublisherDS {
        ...
        public TenantUserDeleteForPublisherDS(ITenantUserDS tenantUserDS, IIdentityServerDS identityServerDS,
