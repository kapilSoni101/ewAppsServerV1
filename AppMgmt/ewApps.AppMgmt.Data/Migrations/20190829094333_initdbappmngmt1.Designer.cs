...
namespace ewApps.AppMgmt.Data.Migrations
{
    ...
    [Migration("20190829094333_initdbappmngmt1")]
    partial class initdbappmngmt1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ewApps.AppMgmt.Entity.Role", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasData(
                        ...
                        new { ID = new Guid("999e9919-ab9e-4e69-bfb0-d6283efa4338"), Active = true, AppId = new Guid("2b031b59-5276-589c-9d75-2a7ae1c799c8"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, PermissionBitMask = 1023L, RoleKey = "admin", RoleName = "Admin", UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), UserType = 3 },
                        new { ID = new Guid("2f1d98f5-f200-4861-bd80-62dd0e6af24c"), Active = true, AppId = new Guid("2b031b59-5276-589c-9d75-2a7ae1c799c8"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, PermissionBitMask = 63L, RoleKey = "admin", RoleName = "Admin", UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), UserType = 4 }
                    );
                });

            modelBuilder.Entity("ewApps.AppMgmt.Entity.RoleLinking", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("RoleLinking","am");

                    b.HasData(
                        new { ID = new Guid("0b03bbe7-b3f7-4978-9411-2b9cb8976579"), AppId = new Guid("8ded3502-01e5-469a-909b-5424d50d00d6"), CreatedBy = new Guid("56b5fb38-838c-4086-9c6e-b5b3f571de0c"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, RoleId = new Guid("df435b1a-7dbd-4e8f-b0f9-c07ba6e84f80"), TenantId = new Guid("18571765-24b5-4c36-a957-416eaec38fda"), TenantUserId = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedBy = new Guid("e330041f-ed94-46bd-b553-a33984a7ead5"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc) }
                    );
                });
            ...
            modelBuilder.Entity("ewApps.AppMgmt.Entity.SubscriptionPlan", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { ID = new Guid("29f50252-433f-4de9-8a4b-7a2360b4ee44"), Active = true, AdditionalPerUserPrice = 0.0, AlertFrequency = 2, AllowCustomization = true, AppId = new Guid("2b031b59-5276-589c-9d75-2a7ae1c799c8"), AutoRenewal = true, CreatedBy = new Guid("0d6dffa2-c0ff-420c-a457-78d4bda103a2"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, FreeUserLicenseCount = 1, GracePeriodInDays = 58, IdentityNumber = "SS#5", NumberOfUsers = 1, PaymentCycle = 1, PlanName = "Executive Plan", PlanSchedule = 1, PriceInDollar = 0m, System = false, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), Term = 90, TrialPeriodInDays = 30, UpdatedBy = new Guid("17dce19c-5058-4bc4-bb08-d2d57352ca5e"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc) }
                    );
                });
