...
namespace ewApps.AppMgmt.Data.Migrations
{
    ...
    [Migration("20190906061728_initdbappmanage346")]
    partial class initdbappmanage346
    {
            ...
            modelBuilder.Entity("ewApps.AppMgmt.Entity.SubscriptionPlan", b =>
                {
                    ...
                    b.HasData(
                        new { ID = new Guid("b37eb8b9-11bf-402e-9048-f9d0a43a426b"), Active = true, AllowUnlimitedTransaction = true, AppId = new Guid("8ded3502-01e5-469a-909b-5424d50d00d6"), BusinessUserCount = 0, CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), CustomerUserCount = 0, Deleted = false, EndDate = new DateTime(2020, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), IdentityNumber = "SS#1", OtherFeatures = "", PaymentCycle = 1, PlanName = "Trial Plan", PriceInDollar = 0m, StartDate = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), TenantId = new Guid("00000000-0000-0000-0000-000000000000"), Term = 15, TermUnit = 1, TransactionCount = 0, UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc) },
                        new { ID = new Guid("d390a264-f0db-49ce-9415-daee1ed4b445"), Active = true, AllowUnlimitedTransaction = true, AppId = new Guid("67d09a6f-ce95-498c-bf69-33c7d38f9041"), BusinessUserCount = 0, CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), CustomerUserCount = 0, Deleted = false, EndDate = new DateTime(2020, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), IdentityNumber = "SS#2", OtherFeatures = "", PaymentCycle = 1, PlanName = "Trial Plan", PriceInDollar = 0m, StartDate = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), TenantId = new Guid("00000000-0000-0000-0000-000000000000"), Term = 15, TermUnit = 1, TransactionCount = 0, UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc) },
                        new { ID = new Guid("8d5e65ca-1b62-4bc3-b0f0-9b3703aabebf"), Active = true, AllowUnlimitedTransaction = true, AppId = new Guid("f4952ef3-f1bd-4621-a5f9-290fd09bc81b"), BusinessUserCount = 0, CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), CustomerUserCount = 0, Deleted = false, EndDate = new DateTime(2020, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), IdentityNumber = "SS#3", OtherFeatures = "", PaymentCycle = 1, PlanName = "Trial Plan", PriceInDollar = 0m, StartDate = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), TenantId = new Guid("00000000-0000-0000-0000-000000000000"), Term = 15, TermUnit = 1, TransactionCount = 0, UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc) }
                    );
                });
            ...
            modelBuilder.Entity("ewApps.AppMgmt.Entity.TenantSubscription", b =>
                {
                    ...
                    b.HasData(
                        new { ID = new Guid("f524047f-1389-412f-904d-0492858c0194"), AppId = new Guid("8ded3502-01e5-469a-909b-5424d50d00d6"), AutoRenew = false, BusinessUserCount = 0, CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), CustomizeSubscription = false, Deleted = false, InactiveComment = "", LogoThumbnailId = new Guid("00000000-0000-0000-0000-000000000000"), PaymentCycle = 1, PriceInDollar = 0m, Status = 0, SubscriptionPlanId = new Guid("b37eb8b9-11bf-402e-9048-f9d0a43a426b"), SubscriptionStartDate = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), SubscriptionStartEnd = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), SystemConfId = new Guid("00000000-0000-0000-0000-000000000000"), TenantId = new Guid("18571765-24b5-4c36-a957-416eaec38fda"), Term = 0, ThemeId = new Guid("46e3cf6c-6cd6-7c12-ed0e-1e906dfe5560"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc) }
                    );
                });
