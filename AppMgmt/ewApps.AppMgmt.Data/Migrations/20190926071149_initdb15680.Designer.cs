...
namespace ewApps.AppMgmt.Data.Migrations
{
    ...
    [Migration("20190926071149_initdb15680")]
    partial class initdb15680
    {
            ...
            modelBuilder.Entity("ewApps.AppMgmt.Entity.App", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { ID = new Guid("f6ad4bf0-c302-4eb1-ab13-35ff9a832add"), Active = true, AppKey = "bankpay", AppScope = 2, AppSubscriptionMode = 2, Constructed = true, CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, IdentityNumber = "APP100015", InactiveComment = "", Name = "BankPayment", ThemeId = new Guid("46e3cf6c-6cd6-7c12-ed0e-1e906dfe5560"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc) }
                    );
                });
