...
namespace ewApps.AppMgmt.QData {
  ...
  /// </summary>
  public partial class QAppMgmtDbContext:DbContext {
    ...
    public QAppMgmtDbContext(DbContextOptions<QAppMgmtDbContext> options, string connString) : base(options) {
    ...
    /// connection string.
    /// </param>
    public QAppMgmtDbContext(DbContextOptions<QAppMgmtDbContext> options, IOptions<AppMgmtAppSettings> appSetting) : base(options) {
