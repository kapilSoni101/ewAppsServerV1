...
namespace ewApps.Core.ThumbnailService
{
  ...
  /// <summary>
  /// This class impliments windows thumbanil methods.
  /// </summary>
  public class WindowsThumbnail
  {
    ...
    public static Bitmap GetThumbnailBitmap(string fileName, int actualWidth = 120, int actualHeight = 120)
    {
      if (actualHeight == 0)
      {
        actualWidth = 120;
      ...
      Bitmap thumbnail = GetThumbnail(
         fileName, actualWidth, actualHeight, ThumbnailOptions.None);
      return thumbnail;
    }
