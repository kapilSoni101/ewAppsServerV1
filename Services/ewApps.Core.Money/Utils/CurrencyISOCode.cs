...
namespace ewApps.Core.Money{
  ...
  /// <seealso cref="https://searchcode.com/codesearch/view/27836890/"/>
  //Used Singular in Enum name as Microsoft also generally uses the singlur for it.
  public enum CurrencyISOCode {
    [Description("Select the currency")] None = 0,
