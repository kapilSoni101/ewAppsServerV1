...
namespace ewApps.Report.QData {
    ...
    /// </summary>
    public interface IQItemMasterReportRepository:IBaseRepository<BaseDTO> {
        ...
        /// <returns></returns>
        Task<List<VendItemMasterReportDTO>> GetBizVendItemMasterListByTenantIdAsync(ReportFilterDTO filter, Guid tenantId, CancellationToken token = default(CancellationToken));
