...
namespace ewApps.Report.QData {
    /// <summary>
    /// This is the repository responsible for filtering data realted to Customer portal Customer App Dashboard and services related to it
    /// </summary>
    public interface IQCustPortCustDashboardRepository:IBaseRepository<BaseDTO> {
