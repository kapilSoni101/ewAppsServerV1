...
namespace ewApps.BusinessEntity.WebApi.Controllers.Business {
    ...
    public class BusBAContractController:ControllerBase {
        ...
        ///// <summary>
        ///// Gets the vendor contract list by business tenant id.
        ///// </summary>
        ///// <param name="businessTenantId">The business tenant id to filter contract list.</param>
        ///// <param name="listDateFilterDTO">The DTO to filter contract list.</param>
        ///// <param name="cancellationToken">The token to cancel async operation.</param>
        ///// <returns>Returns vendor contract list that matches given tenant id.</returns>
        //[HttpPut]
        ...
        ///// <summary>
        ///// Gets the vendor contract detail by business tenant id and contract identifier.
        ///// </summary>
        ///// <param name="businessTenantId">The business tenant identifier.</param>
        ///// <param name="contractId">The contract identifier.</param>
        ///// <param name="cancellationToken">The cancellation token.</param>
        ///// <returns>Returns vendor contract detail that matches given business tenant and contract id.</returns>
        //[HttpGet]
