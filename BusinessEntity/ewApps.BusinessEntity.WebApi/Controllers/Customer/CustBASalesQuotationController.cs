...
namespace ewApps.BusinessEntity.WebApi {
    ...
    public async Task AddSalesOrderWithItemForCust([FromBody] CustBASalesQuotationAddDTO dto, CancellationToken cancellationToken = default(CancellationToken))
    {
      await _custBASalesQuotationDS.AddSalesQuotationWithItem(dto, cancellationToken);
    }
