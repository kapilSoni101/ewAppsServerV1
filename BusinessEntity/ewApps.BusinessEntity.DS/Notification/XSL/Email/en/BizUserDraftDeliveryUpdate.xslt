...
<!--Subject – <Publisher Co. Name> Business Portal: Exiting Draft Delivery <ID> against <Customer Co. Name> is updated. 

Dear <Business Co. Name>, 

Existing Draft Delivery <ID> is updated on <date & time>: 

Draft Delivery ID: <ID> 
Customer Name: <Business Partner Co. Name> 
Customer ID: < Business Partner Co. ID> 
Updated By: <Business User Name>, User ID: <user id>. Please login to the portal to view more details. 
    ...
    <html>
      <head>
        <title>          
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Business Portal: Exiting Draft Delivery </xsl:text>
          <xsl:text> </xsl:text>
