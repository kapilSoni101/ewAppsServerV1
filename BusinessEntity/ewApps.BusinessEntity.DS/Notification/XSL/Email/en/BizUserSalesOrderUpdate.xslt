...
<!--Subject – <Publisher Co. Name> Business Portal: Exiting Sales Order <Order ID> against <Customer Co. Name> is updated. 

Dear <Business Co. Name>, 
Existing Sales Order <Order ID> is updated on <date & time>:
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Business Portal: Existing Sales Order </xsl:text>
          <xsl:text> </xsl:text>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text> Existing Sales Order </xsl:text>
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="$ID"/>
                  <xsl:text> </xsl:text>
