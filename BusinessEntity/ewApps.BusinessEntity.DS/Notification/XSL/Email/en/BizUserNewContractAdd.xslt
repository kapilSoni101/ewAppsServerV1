...
<!--Subject – <Publisher Co. Name> Business Portal: New Contract <ID> is created for <Customer Co. Name>. 
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Business Portal: New Contract </xsl:text>
          <xsl:text> </xsl:text>
          <xsl:value-of select="$ID"/>
          <xsl:text> </xsl:text>
          <xsl:text> is created for </xsl:text>
          <xsl:text> </xsl:text>
