...
Subject – <Publisher Co. Name> Customer Portal: Exiting Sales Order <Order ID> is updated. 
...
Portal URL: <Customer Portal - Customer URL> 
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Customer Portal: Existing Sales Order </xsl:text>
          <xsl:text> </xsl:text>
