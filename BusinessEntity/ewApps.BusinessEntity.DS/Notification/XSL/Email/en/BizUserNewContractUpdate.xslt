...
<!--Subject – <Publisher Co. Name> Business Portal: Exiting Contract <ID> of <Customer Co. Name> is updated. 

Dear <Business Co. Name>, 

Existing Contract <ID> is updated on <date & time>: 
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Business Portal: Exiting Contract </xsl:text>
          <xsl:text> </xsl:text>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text> Existing Contract </xsl:text>
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="$ID"/>
                  <xsl:text> </xsl:text>
