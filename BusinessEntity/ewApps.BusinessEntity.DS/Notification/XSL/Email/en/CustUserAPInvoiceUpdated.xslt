...
Subject – <Publisher Co. Name> Customer Portal: Exiting A/P Invoice is updated. 

Dear <Customer Co. Name>, 

Existing A/P Invoice <Invoice ID> is updated on <date & time>: 
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> Customer Portal: Exiting A/P Invoice </xsl:text>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text>, </xsl:text>
                  <xsl:text> Existing A/P Invoice </xsl:text>
                  <xsl:value-of select="$invoiceNo"/>
