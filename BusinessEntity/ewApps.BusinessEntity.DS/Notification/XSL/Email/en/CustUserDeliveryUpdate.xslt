...
Subject – <Publisher Co. Name> Customer Portal: Exiting Delivery <ID> is updated.

Dear <Business Co. Name>, // Change  to customer company name as discussed with rajesh

Existing Delivery <ID> is updated on <date & time>: 
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Customer Portal: Exiting Delivery </xsl:text>
          <xsl:text> </xsl:text>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text> Existing Delivery  </xsl:text>
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="$ID"/>
                  <xsl:text> </xsl:text>
