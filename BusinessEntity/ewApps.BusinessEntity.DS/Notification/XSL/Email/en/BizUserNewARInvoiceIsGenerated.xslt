...
<!--
Subject – <Publisher Co. Name> Business Portal: New user is onboard <Payment> application.

Dear <Business Co. Name>, 

You have a new user <New User> onboard <Payment> application on <Publisher Co. Name> Business Portal on <date & time>.
  ...
  <xsl:template match="/">
    <html>
      <head>
        <title>
          <!--HTML document title-->
          <!--– <Publisher Co. Name> Business Portal: New A/R Invoice is generated for <Customer Co. Name>. -->
          <xsl:value-of select="$publisherName"/>
          <xsl:text> Business Portal: New A/R Invoice is generated for </xsl:text>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text>, </xsl:text>
                  <xsl:text> A new invoice with below details is generated: Customer Name: </xsl:text>
                  <xsl:value-of select="$customerName"/>
