...
Subject – <Publisher Co. Name> Customer Portal: New A/P Invoice is generated of amount <amount with currency>. 

Dear <Customer Co. Name>,
A New A/P Invoice with below details is generated:
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> Customer Portal: New A/P Invoice is generated of amount </xsl:text>
          <xsl:text> </xsl:text>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text>, </xsl:text>
                  <xsl:text> A New A/P Invoice with below details is generated: </xsl:text>
            ...
            <td valign="top" align="center" class="textContent">
              <div style="text-align:left;font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px;margin-bottom:0;color:#000;line-height:19px;">
                ...
                <p style="font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px; color:#000;">
                  ...
                  <xsl:text> </xsl:text>
                  <b>
                    <xsl:text> A/P Invoice </xsl:text>
                  </b>
                  <xsl:text> </xsl:text>
                  <xsl:text> with below details </xsl:text>
                  <xsl:text> </xsl:text>
                  <b>
