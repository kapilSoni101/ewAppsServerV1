...
<!--Subject – <Publisher Co.="" Name=""> Business Portal: New Sales Quotation <ID> is generated for <Customer Co.="" Name="">.

Dear <Business Co.="" Name="">,

A New Sales Quotation with below details is generated: 
...
Regards 
Publisher Co. Name> (<Customer Portal="">
Application) 
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Business Portal: New Sales Quotation </xsl:text>
          <xsl:text> </xsl:text>
          <xsl:value-of select="$ID"/>
          <xsl:text> </xsl:text>
          <xsl:text> is generated for </xsl:text>
          <xsl:text> </xsl:text>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text>, </xsl:text>
                  <xsl:text> A New Sales Quotation with below details is generated: </xsl:text>
                  <xsl:text> </xsl:text>
            ...
            <td valign="top" align="center" class="textContent">
              <div style="text-align:left;font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px;margin-bottom:0;color:#000;line-height:19px;">
                ...
                <p style="font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px; color:#000;">
                  ...
                  <xsl:text> </xsl:text>
                  <b>
                    <xsl:text> Sales Quotation </xsl:text>
                  </b>
                  <xsl:text> </xsl:text>
