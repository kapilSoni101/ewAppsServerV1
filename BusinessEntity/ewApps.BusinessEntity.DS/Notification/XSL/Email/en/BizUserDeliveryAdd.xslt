...
<!--Subject – <Publisher Co. Name> Business Portal: New Delivery <ID> is initiated for <Customer Co. Name>. 
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Business Portal: New Delivery </xsl:text>
          <xsl:text> </xsl:text>
          <xsl:value-of select="$ID"/>
          <xsl:text> </xsl:text>
          <xsl:text> is initiated for </xsl:text>
          <xsl:text> </xsl:text>
