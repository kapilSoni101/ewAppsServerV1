...
<!--
Subject – <Publisher Co. Name> Business Portal: New Sales Order <ID> is generated against <Customer Co. Name>. 

Dear <Business Co. Name>, A New Sales Order with below details is generated: 
Customer Name: <Customer Co. Name> 
Customer ID: < Customer ID> 
Sales Order ID: <ID>. 
Total Amount: <Total amount with currency type> 
Posting Date: <Date and Time> 
  ...
  <xsl:template match="/">
    <html>
      <head>
        <title>
          <!--HTML document title-->
          <!--– <Publisher Co. Name> Business Portal: New Sales Order <ID> is generated against <Customer Co. Name>. -->
          <xsl:value-of select="$publisherName"/>
          <xsl:text> Business Portal: New Sales Order </xsl:text>
          <xsl:value-of select="$salesOrderNo"/>
          <xsl:text> is generated against </xsl:text>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text>, </xsl:text>
                  <xsl:text> A New Sales Order with below details is generated: Customer Name: </xsl:text>
                  <xsl:value-of select="$customerName"/>
