...
Subject – <Publisher Co. Name> Customer Portal: New Sales Quotation <ID> is generated for <amount with currency>. 
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Customer Portal: New Sales Quotation </xsl:text>
          <xsl:text> </xsl:text>
