...
<!--
Subject – <Publisher Co. Name> Business Portal: Exiting A/R Invoice <Invoice ID> against <Customer Co. Name> is updated. 
Dear <Business Co. Name>,  
Existing A/R Invoice <Invoice ID> is updated on <date & time>: 
  ...
  <xsl:template match="/">
    <html>
      <head>
        <title>
          <!--HTML document title-->
          <!--– <Publisher Co. Name> Business Portal: Exiting A/R Invoice <Invoice ID> against <Customer Co. Name> is updated.  -->
          <xsl:value-of select="$publisherName"/>
          <xsl:text> Business Portal: Exiting A/R Invoice </xsl:text>
