...
Subject – <Publisher Co. Name> Customer Portal: New Delivery <ID> is initiated. 
...
<Copyright text set at the Publisher> Y
ou received this email because you are subscribed to Portal Alerts from <Business Co. Name>. 
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Customer Portal: New Delivery </xsl:text>
          <xsl:text> </xsl:text>
          <xsl:value-of select="$ID"/>
          <xsl:text> </xsl:text>
          <xsl:text> is initiated.</xsl:text>
        </title>
        <style type="text/css">
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text> A New Delivery with below details is initiated:  </xsl:text>
                  <xsl:text> </xsl:text>               
