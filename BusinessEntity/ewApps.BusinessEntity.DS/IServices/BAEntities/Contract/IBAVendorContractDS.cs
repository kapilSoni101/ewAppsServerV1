...
namespace ewApps.BusinessEntity.DS
{
  ...
  /// </summary>
  public interface IBAVendorContractDS : IBaseDS<BAVendorContract>
  {
    /// <summary>
    ...
    Task<IEnumerable<BusBAVendorContractDTO>> GetContractListByTenantIdAsync(Guid tenantId, ListDateFilterDTO listDateFilterDTO, CancellationToken cancellationToken = default(CancellationToken));
    ...
    Task AddContractListAsync(List<BAVendorContractSyncDTO> contractList, Guid tenantId, Guid tenantUserId, bool isBulkInsert, CancellationToken token = default(CancellationToken));

    Task<IEnumerable<VendorBAContractDTO>> GetContractListByTenantIdAsyncForVendor(Guid tenantId, ListDateFilterDTO listDateFilterDTO, CancellationToken cancellationToken = default(CancellationToken));
