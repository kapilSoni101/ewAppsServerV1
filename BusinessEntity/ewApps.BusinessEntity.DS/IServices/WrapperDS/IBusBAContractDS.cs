...
namespace ewApps.BusinessEntity.DS {
    ...
    /// </summary>
    public interface IBusBAContractDS {
        ...
        Task<IEnumerable<BusBAContractDTO>> GetContractListByBusinessIdAsync(Guid businessTenantId, ListDateFilterDTO listDateFilterDTO, CancellationToken cancellationToken = default(CancellationToken));
        ...
        ///// <param name="cancellationToken">The token to cancel async operation.</param>
        ///// <returns>Returns contract list that matches given business tenant id.</returns>
        //Task<IEnumerable<BusBAContractDTO>> GetVendorContractListByBusinessIdAsync(Guid businessTenantId, ListDateFilterDTO listDateFilterDTO, CancellationToken cancellationToken = default(CancellationToken));
        ...
        ///// <param name="cancellationToken">The cancellation token.</param>
        ///// <returns>Returns contract detail that matches given business tenant  and contract id.</returns>
        //Task<BusBAContractViewDTO> GetVendorContractDetailByContractIdAsync(Guid businessTenantId, Guid contractId, CancellationToken cancellationToken = default(CancellationToken));
    }
}
