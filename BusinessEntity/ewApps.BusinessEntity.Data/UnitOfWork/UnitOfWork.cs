...
namespace ewApps.BusinessEntity.Data {
  ...
  public class UnitOfWork:IUnitOfWork {
    ...
    private readonly BusinessEntityDbContext _busEntitydbContext;
    ...
    public UnitOfWork(BusinessEntityDbContext busEntitydbContext, bool disableSaveChanges= false) {
      _busEntitydbContext = busEntitydbContext;
    ...
    public void Save() {
      if(_disableSaveChanges == false) {
        _busEntitydbContext.SaveChanges();
      }
    }
    ...
    public async Task SaveAsync() {
      if(_disableSaveChanges == false) {
        await _busEntitydbContext.SaveChangesAsync();
      }
    }
