...
namespace ewApps.BusinessEntity.Data {
    ...
    /// </summary>
    public interface IBAContractItemRepository:IBaseRepository<BAContractItem> {
        ...
        IQueryable<BusBAContractItemDTO> GetContractItemListByContractId(Guid businessTenantId, Guid contractId);

        IQueryable<CustBAContractItemDTO> GetContractItemListByContractIdForCust(Guid businessTenantId, Guid contractId);
    }
}
