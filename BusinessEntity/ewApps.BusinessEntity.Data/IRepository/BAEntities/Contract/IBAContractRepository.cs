...
namespace ewApps.BusinessEntity.Data {
    ...
    /// </summary>
    public interface IBAContractRepository:IBaseRepository<BAContract> {
        ...
        IQueryable<BusBAContractDTO> GetContractListByTenantId(Guid tenantId, ListDateFilterDTO listDateFilterDTO);
        ...
        IQueryable<CustBAContractDTO> GetContractListByTenantIdForCust(Guid tenantId, ListDateFilterDTO listDateFilterDTO);
