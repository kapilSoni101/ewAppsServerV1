...
namespace ewApps.BusinessEntity.Data {
  ...
  // </summary>
  public interface IBASalesQuotationItemRepository: IBaseRepository<BASalesQuotationItem> {
        ...
        /// <returns></returns>
        IQueryable<BusBASalesQuotationItemDTO> GetSalesQuotationItemListBySalesQuotationId(Guid salesQuotationId);

        IQueryable<CustBASalesQuotationItemDTO> GetSalesQuotationItemListBySalesQuotationIdForCust(Guid salesQuotationId);
