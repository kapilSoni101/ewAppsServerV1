...
namespace ewApps.BusinessEntity.Data.Migrations
{
    ...
    [Migration("20190909134553_initdnbe669")]
    partial class initdnbe669
    {
            ...
            modelBuilder.Entity("ewApps.BusinessEntity.Entity.BAContractItem", b =>
                {
                    ...
                    b.Property<decimal>("CummlativeAmountLC")
                        .HasColumnType("decimal(18, 5)");

                    b.Property<decimal>("CummlativeCommittedAmount")
                        .HasColumnType("decimal(18, 5)");

                    b.Property<int>("CummlativeCommittedQuantity");

                    b.Property<int>("CummlativeQuantity");
            ...
            modelBuilder.Entity("ewApps.BusinessEntity.Entity.ERPConnector", b =>
                {
                    ...
                    b.HasData(
                        new { ID = new Guid("aaea4427-53f8-4ef8-b821-caff358cbd92"), Active = true, CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, Name = "SAP", TenantId = new Guid("18571765-24b5-4c36-a957-416eaec38fda"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc) }
                    );
                });
