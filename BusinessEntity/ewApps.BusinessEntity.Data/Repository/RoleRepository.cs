...
namespace ewApps.BusinessEntity.Data {
    ...
    /// </summary>
    public class RoleRepository:BaseRepository<Role, BusinessEntityDbContext>, IRoleRepository {
        ...
        public RoleRepository(BusinessEntityDbContext context, IUserSessionManager sessionManager) : base(context, sessionManager) {
        }
