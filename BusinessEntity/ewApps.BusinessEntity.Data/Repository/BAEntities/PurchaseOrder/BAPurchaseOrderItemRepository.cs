...
namespace ewApps.BusinessEntity.Data {
  ...
  /// </summary>
  public class BAPurchaseOrderItemRepository:BaseRepository<BAPurchaseOrderItem, BusinessEntityDbContext>, IBAPurchaseOrderItemRepository  {
    ...
    public BAPurchaseOrderItemRepository(BusinessEntityDbContext context, IUserSessionManager sessionManager) : base(context, sessionManager) {
    }
