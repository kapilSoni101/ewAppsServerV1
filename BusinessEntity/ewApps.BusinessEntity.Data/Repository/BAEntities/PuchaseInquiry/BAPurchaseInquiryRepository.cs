...
namespace ewApps.BusinessEntity.Data {
  ...
  /// </summary>
  public class BAPurchaseInquiryRepository:BaseRepository<BAPurchaseInquiry, BusinessEntityDbContext>, IBAPurchaseInquiryRepository {
    ...
    /// <param name="sessionManager">User session manager instance to get login user details.</param>
        public BAPurchaseInquiryRepository(BusinessEntityDbContext context, IUserSessionManager sessionManager) : base(context, sessionManager) {
    }
