...
namespace ewApps.BusinessEntity.Entity {
  ...
  /// </summary>
  [Table("BAARInvoice", Schema ="be")]
  public class BAARInvoice:BaseEntity {

        /// <summary>
        /// The entity name.
        /// </summary>
        public const string EntityName = "BAARInvoice";
        ...
        /// <inheritdoc />
        public IEnumerable<EwpErrorData> BrokenRules(BAARInvoice entity) {
