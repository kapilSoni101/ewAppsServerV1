...
namespace ewApps.BusinessEntity.DTO {
    ...
    /// </summary>
    public class BADeliverySyncDTO {
        ...
        /// </summary>
        public List<BADeliveryAttachmentSyncDTO> Attachments {
            get; set;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static BADelivery MapToEntity(BADeliverySyncDTO model) {

            BADelivery entity = new BADelivery();
    ...
    /// </summary>
    /// <returns></returns>
    public static BADelivery MapToEntity(BADeliverySyncDTO model, BADelivery entity)
    {
      entity.ContactPerson = model.ContactPerson;
      entity.DeliveryDate = model.DeliveryDate;
      entity.Discount = model.Discount;
