...
namespace ewApps.BusinessEntity.DTO {
    ...
    /// invoice item data.
    /// </summary>
    public class BAAPInvoiceItemSyncDTO {
        ...
        /// </summary>
        /// <returns>BAAPInvoiceItem</returns>
        public static BAAPInvoiceItem MapToEntity(BAAPInvoiceItemSyncDTO model) {
            BAAPInvoiceItem entity = new BAAPInvoiceItem() {
                ERPAPInvoiceItemKey = model.ERPAPInvoiceItemKey,
                ERPAPInvoiceKey = model.ERPAPInvoiceKey,
                ERPItemKey = model.ERPItemKey,
                APInvoiceID = model.APInvoiceID,
