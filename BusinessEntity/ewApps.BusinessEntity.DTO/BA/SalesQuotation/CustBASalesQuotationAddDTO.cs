...
namespace ewApps.BusinessEntity.DTO {
    ...
    public class CustBASalesQuotationAddDTO{
        ...
        /// </summary>
        [NotMapped]
        public List<CustBASalesQuotationItemDTO> SalesQuotationItemList {
            get;set;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static BASalesQuotation MapToEntity(CustBASalesQuotationAddDTO model, BASalesQuotation entity) {
            ...
            //entity.Pic = model.PickAndPackRemarks;
