...
Dear <Invited Payment User Name>,

<Business (Application) Inviting User Name> hereby invites you to join <Publisher Co. Name> Business Portal - <Application Name>.
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:param name="invitedPaymentUserName"/>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:value-of select="$invitedPaymentUserName"/>
                  <xsl:text>, </xsl:text>
