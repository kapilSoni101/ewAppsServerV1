...
<Business (Application) Inviting User Name> hereby invites you to join <Publisher Co. Name> Business Portal - <Application Name>. It seems that this email id <email id> already exists on <portal name on which set password done>, please use the existing credentials for login.
