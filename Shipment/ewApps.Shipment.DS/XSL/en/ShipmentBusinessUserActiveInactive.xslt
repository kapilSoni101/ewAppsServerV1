...
<!--Subject – <Publisher Co. Name> Business Portal - <Application Name>: Your account status is changed.

Dear <Business (Application) User Name>,

<Business User Name who made the change> has set your account as <status> for <Application Name> application. You can contact your Portal Admin for more details.
    ...
    <html>
      <head>
        <title>                           
          ...
          <xsl:text> </xsl:text>
          <xsl:text>: Your account status is changed.</xsl:text>                 
        </title>
        <style type="text/css">
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text> </xsl:text>
                  <xsl:text>has set your account as </xsl:text>
                  <xsl:text> </xsl:text>
                  ...
                  <xsl:value-of select="$applicationName"/>
                  <xsl:text> </xsl:text>
                  <xsl:text> application. You can contact your Portal Admin for more details. </xsl:text>                 
