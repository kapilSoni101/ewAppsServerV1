...
<!--Subject – <Publisher Co. Name> Business Portal - <Application Name>: <Application Name> application access is allowed.

Dear <Business (Application) User Name>,

You have been given access to <Application Name> application on <Publisher Co. Name> Business Portal - <Application Name>.
      ...
      <head>
        <title>            
         ...
         <xsl:value-of select="$publisherCompanyName"/>
          ...
          <xsl:value-of select="$applicationName"/>
          <xsl:text> </xsl:text>
          <xsl:text> application access is allowed. </xsl:text>         
        </title>
        <style type="text/css">
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text> You have been given access to</xsl:text> 
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="$applicationName"/>
                  <xsl:text> </xsl:text>
