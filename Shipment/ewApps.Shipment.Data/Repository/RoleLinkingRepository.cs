...
namespace ewApps.Shipment.Data {
    ...
    /// </summary>
    public class RoleLinkingRepository : BaseRepository<RoleLinking, ShipmentDbContext>, IRoleLinkingRepository {
    ...
    public RoleLinkingRepository(ShipmentDbContext context, IUserSessionManager sessionManager) : base(context, sessionManager) {
    } 
