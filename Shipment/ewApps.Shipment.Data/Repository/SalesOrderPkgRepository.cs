...
namespace ewApps.Shipment.Data {
    ...
    /// </summary>
    public class SalesOrderPkgRepository:BaseRepository<SalesOrderPkg, ShipmentDbContext>, ISalesOrderPkgRepository {
        ...
        public SalesOrderPkgRepository(ShipmentDbContext context, IUserSessionManager sessionManager) : base(context, sessionManager) {
