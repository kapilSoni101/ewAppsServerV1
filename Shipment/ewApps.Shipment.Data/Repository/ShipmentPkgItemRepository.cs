...
namespace ewApps.Shipment.Data {
    ...
    /// </summary>
    public class ShipmentPkgItemRepository:BaseRepository<ShipmentPkgItem, ShipmentDbContext>, IShipmentPkgItemRepository {
        ...
        public ShipmentPkgItemRepository(ShipmentDbContext context, IUserSessionManager sessionManager) : base(context, sessionManager) {
