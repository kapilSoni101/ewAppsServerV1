...
namespace ewApps.Payment.Data {
    ...
    /// </summary>
    public class RoleRepository:BaseRepository<Role, PaymentDbContext>, IRoleRepository {
        ...
        public RoleRepository(PaymentDbContext context, IUserSessionManager sessionManager) : base(context, sessionManager) {
        }
