...
namespace ewApps.Payment.DS {
    ...
    /// </summary>
    public class SchedulePaymentLogDS:BaseDS<SchedulePaymentLog>, ISchedulePaymentLogDS {

        #region Member variable

        ISchedulePaymentLogRepository _recurringPaymentRepository;
        ...
        private const string SchedulePaymentLogDocumentType = "SchedulePaymentLog";
        ...
        public SchedulePaymentLogDS(ISchedulePaymentLogRepository recurringPaymentRepository,           
