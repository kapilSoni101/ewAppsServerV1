...
namespace ewApps.Payment.DS {
    ...
    /// </summary>
    public class SchedulePaymentDS:BaseDS<SchedulePayment>, ISchedulePaymentDS {

        #region Member variable

        ISchedulePaymentRepository _recurringPaymentRepository;
        IPaymentUnitOfWork _unitOfWork;       
        IUserSessionManager _usManager;
        PaymentAppSettings _appSetting;
        ISchedulePaymentDetailDS _schedulePaymentDetailDS;
        ISchedulePaymentLogDS _schedulePaymentLogDS;

        private const string RecurringDocumentType = "SchedulePayment";
        ...
        public SchedulePaymentDS(ISchedulePaymentRepository recurringPaymentRepository,
            ISchedulePaymentDetailDS schedulePaymentDetailDS,
            ...
            _schedulePaymentDetailDS = schedulePaymentDetailDS;
        ...
        private async Task AddPaymentLog(ScheduledJobDTO scheduleJobDto, RecurringPaymentDTO recPayDto, RecurringPaymentLogStateEnum state, Guid tenantId, CancellationToken token = default(CancellationToken)) {
            SchedulePaymentLog payLog = new SchedulePaymentLog();
            payLog.ScheduledDate = scheduleJobDto.ScheduledTime;
            payLog.SchedulePaymentId = scheduleJobDto.SourceId;
            ...
            await _schedulePaymentLogDS.AddAsync(payLog, token);
        }
