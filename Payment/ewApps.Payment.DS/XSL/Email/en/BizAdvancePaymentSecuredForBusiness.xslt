...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!--Subject – <Publisher Co. Name> Business Portal - New Advance Payment initiated for <Customer Co. Name>. 
  
  Dear <Business Co. Name>,  
  
  Advance Payment is initiated for a customer with below details on <date & time>. 
  ...
  Initiated By: <Business/Customer User Name>, User ID: <user id>
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Business Portal - New Advance Payment initiated for</xsl:text>
          <xsl:text> </xsl:text>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text>, </xsl:text>
                  <xsl:text> Advance Payment is initiated for a customer with below details on </xsl:text>
