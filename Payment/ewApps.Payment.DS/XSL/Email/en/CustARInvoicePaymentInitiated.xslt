...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!--Subject – <Publisher Co. Name> Customer Portal - New Payment initiated for Invoice(s). 
  
  Dear <Customer Co. Name>, 
  
  Payment with below details initiated against the listed A/P Invoice(s) by Customer user, <Payee Name>, User ID <Payee ID>.
    ...
    <html>
      <head>
        <title> 
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Customer Portal - New Payment initiated for Invoice(s). </xsl:text>         
        </title>
        <style type="text/css">
