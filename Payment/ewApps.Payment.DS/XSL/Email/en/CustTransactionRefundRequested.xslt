...
Subject – <Publisher Co. Name> Customer Portal: Transaction <transaction ID> is Refund Requested. 

Dear <Customer Co. Name>, Refund is initiated by <Business Co. Name> for a transaction with below details on <date & time>. 
