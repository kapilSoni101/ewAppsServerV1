...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!--Subject – <Publisher Co. Name> Customer Portal: Pre – Authorization is secured for <amount with currency>. 
  
  Dear <Customer Co. Name>, 
  
  Pre - Auth is secured by <Business Co. Name> with below details on <date & time>. 
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Customer Portal: Pre – Authorization is secured for </xsl:text>
          <xsl:text> </xsl:text>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text>, </xsl:text>         
                  <xsl:text> Pre - Auth is secured by </xsl:text>      
                  <xsl:text> </xsl:text>  
