...
namespace ewApps.AppPortal.Data {
    ...
    /// </summary>
    public class RoleLinkingRepository : BaseRepository<RoleLinking, AppPortalDbContext>, IRoleLinkingRepository {
    ...
    public RoleLinkingRepository(AppPortalDbContext context, IUserSessionManager sessionManager) : base(context, sessionManager) {
    } 
