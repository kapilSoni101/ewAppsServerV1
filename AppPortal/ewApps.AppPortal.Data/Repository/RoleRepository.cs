...
namespace ewApps.AppPortal.Data {
    ...
    /// </summary>
    public class RoleRepository:BaseRepository<Role, AppPortalDbContext>, IRoleRepository {
        ...
        public RoleRepository(AppPortalDbContext context, IUserSessionManager sessionManager) : base(context, sessionManager) {
        }
