...
namespace ewApps.AppPortal.Data.Migrations
{
    ...
    [Migration("20191108102017_appfavoritemaster4")]
    partial class appfavoritemaster4
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ewApps.AppPortal.Entity.ASNotification", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<Guid?>("LinkNotificationId");
            ...
            modelBuilder.Entity("ewApps.AppPortal.Entity.Business", b =>
                {
                    ...
                    b.Property<string>("FederalTexId")
                        .HasMaxLength(100);
                    ...
                    b.Property<bool>("InitDB");

                    b.Property<bool>("IntegratedMode");
            ...
            modelBuilder.Entity("ewApps.AppPortal.Entity.CustomerAccountDetail", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("CustomerAccountDetail","ap");
                });

            modelBuilder.Entity("ewApps.AppPortal.Entity.Favorite", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("Favorite","ap");

                    b.HasData(
                        new { ID = new Guid("eeec0c47-9c5e-4bde-914b-39a3e3a387ee"), AppId = new Guid("2b031b59-5276-589c-9d75-2a7ae1c799c8"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Transaction History", PortalKey = "BizPortal", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "/feature/payapp/transaction/history" },
                        new { ID = new Guid("c810c5d9-a559-4242-89a7-7283adb4ca7a"), AppId = new Guid("2b031b59-5276-589c-9d75-2a7ae1c799c8"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Receive Payment", PortalKey = "BizPortal", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "arinvoices" },
                        new { ID = new Guid("8b5bb0f6-6e57-4529-93bc-9a8b45651b73"), AppId = new Guid("2b031b59-5276-589c-9d75-2a7ae1c799c8"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Refund", PortalKey = "BizPortal", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "arinvoices" },
                        new { ID = new Guid("083972f2-8eeb-4a99-92f1-6097a18cb094"), AppId = new Guid("2b031b59-5276-589c-9d75-2a7ae1c799c8"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Void a Payment", PortalKey = "BizPortal", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "transaction/void" },
                        new { ID = new Guid("4a5519b6-e2c9-42e2-9715-cae5af638b15"), AppId = new Guid("8c6fa8ce-6b94-428f-95de-5ed8859260d2"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Transaction History", PortalKey = "BizPortal", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "/feature/custapp/transaction/history" },
                        new { ID = new Guid("8120877e-3351-4f1b-924e-9934551f176e"), AppId = new Guid("8c6fa8ce-6b94-428f-95de-5ed8859260d2"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Receive Payment", PortalKey = "BizPortal", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "arinvoices" },
                        new { ID = new Guid("c4285a44-32e9-4c4a-b186-843b6c31b4fb"), AppId = new Guid("8c6fa8ce-6b94-428f-95de-5ed8859260d2"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Refund", PortalKey = "BizPortal", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "arinvoices" },
                        new { ID = new Guid("4e5a3aa9-86bc-4dea-9acf-136678ef8cfe"), AppId = new Guid("8c6fa8ce-6b94-428f-95de-5ed8859260d2"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Void a Payment", PortalKey = "BizPortal", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "/feature/custapp/transaction/history" },
                        new { ID = new Guid("fcd4ccc7-eeba-49de-a1aa-83f1cd57a3e8"), AppId = new Guid("2b031b59-5276-589c-9d75-2a7ae1c799c8"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Transaction History", PortalKey = "CustPortal", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "payment/history" },
                        new { ID = new Guid("98f338c6-fada-4c44-8f09-298f4c6cc292"), AppId = new Guid("2b031b59-5276-589c-9d75-2a7ae1c799c8"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Make a Payment", PortalKey = "CustPortal", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "payment" },
                        new { ID = new Guid("b2bd694f-004e-42c3-bad8-3478c37bcec4"), AppId = new Guid("8c6fa8ce-6b94-428f-95de-5ed8859260d2"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Create Order", PortalKey = "CustPortal", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "Orders" },
                        new { ID = new Guid("c75c4053-8b86-445b-819f-0fbe2028b74b"), AppId = new Guid("8c6fa8ce-6b94-428f-95de-5ed8859260d2"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Receive Payment", PortalKey = "CustPortal", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "apayment" },
                        new { ID = new Guid("9d74d0f6-d07c-4a90-884f-92e454c78349"), AppId = new Guid("8c6fa8ce-6b94-428f-95de-5ed8859260d2"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Transaction History", PortalKey = "CustPortal", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "payment/history" },
                        new { ID = new Guid("438a6e60-4b05-4896-8344-f7f660b3b629"), AppId = new Guid("67d09a6f-ce95-498c-bf69-33c7d38f9041"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = " Invite Business", PortalKey = "PubPortal", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "payment/history" },
                        new { ID = new Guid("e406a4db-030d-4864-908e-08332bb6ab98"), AppId = new Guid("67d09a6f-ce95-498c-bf69-33c7d38f9041"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Open Tickets", PortalKey = "PubPortal", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "payment/history" }
                    );
                });
            ...
            modelBuilder.Entity("ewApps.AppPortal.Entity.Notes", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ewApps.AppPortal.Entity.Portal", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { ID = new Guid("929632bc-0327-4b35-bbe6-cb7a2bfbc3bd"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, Name = "Vendor Portal", PortalKey = "VendPortal", UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), UserType = 5 },
            ...
            modelBuilder.Entity("ewApps.AppPortal.Entity.PortalAppLinking", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { ID = new Guid("2657f722-c6dd-44b7-8c3b-432ecf797cdc"), AppId = new Guid("3252c1cf-c74a-4d0d-b0ce-a6271aefc0a2"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, PortalId = new Guid("0919810e-536c-42f5-a130-1cb62605508d"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc) },
                        ...
                        new { ID = new Guid("a8e9a7c5-57d1-43a4-afd3-e70a8ce59608"), AppId = new Guid("283259b7-952c-4f9b-9399-16a28ed08580"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, PortalId = new Guid("929632bc-0327-4b35-bbe6-cb7a2bfbc3bd"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc) }
                    );
                });

            modelBuilder.Entity("ewApps.AppPortal.Entity.PubBusinessSubsPlan", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("PubBusinessSubsPlan","ap");
                });

            modelBuilder.Entity("ewApps.AppPortal.Entity.PubBusinessSubsPlanAppService", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<Guid>("PubBusinessSubsPlanId");

                    b.Property<string>("ServiceAttributeName")
                        .IsRequired()
                        .HasMaxLength(200);
                    ...
                    b.Property<Guid>("SubsPlanAppServiceAttributeId");

                    b.Property<Guid>("SubsPlanAppServiceId");
                    ...
                    b.ToTable("PubBusinessSubsPlanAppService","ap");
                });
            ...
            modelBuilder.Entity("ewApps.AppPortal.Entity.TenantAppLinking", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ewApps.AppPortal.Entity.ViewSettings", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("ViewSettingJson");

                    b.HasKey("ID");

                    b.ToTable("ViewSettings","ap");
                });
