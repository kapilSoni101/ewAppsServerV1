...
namespace ewApps.AppPortal.Data.Migrations
{
    ...
    [Migration("20190829143244_initappportaldb5")]
    partial class initappportaldb5
    {
            ...
            modelBuilder.Entity("ewApps.AppPortal.Entity.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { ID = new Guid("09116a01-2ed7-42a9-962c-c07999f40340"), Active = true, AppId = new Guid("2b031b59-5276-589c-9d75-2a7ae1c799c8"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, PermissionBitMask = 63L, RoleKey = "admin", RoleName = "Admin", UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), UserType = 4 }
                    );
                });
            ...
            modelBuilder.Entity("ewApps.AppPortal.Entity.RoleLinking", b =>
                {
                    ...
                    b.HasData(
                        new { ID = new Guid("0b03bbe7-b3f7-4978-9411-2b9cb8976579"), AppId = new Guid("8ded3502-01e5-469a-909b-5424d50d00d6"), CreatedBy = new Guid("65fa80f3-4a76-43df-ae92-8ea37c09ad5f"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, RoleId = new Guid("df435b1a-7dbd-4e8f-b0f9-c07ba6e84f80"), TenantId = new Guid("18571765-24b5-4c36-a957-416eaec38fda"), TenantUserId = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedBy = new Guid("a60304b8-145e-4a4d-a251-5bef00099601"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc) }
                    );
                });
