...
namespace ewApps.AppPortal.Data.Migrations
{
    ...
    [Migration("20190829095353_initappportaldb")]
    partial class initappportaldb
    {
            ...
            modelBuilder.Entity("ewApps.AppPortal.Entity.Portal", b =>
                {
                    ...
                    b.HasData(
                        new { ID = new Guid("8ded3502-01e5-469a-909b-5424d50d00d6"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, Name = "Platform Portal", PortalKey = "PlatPortal", UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), UserType = 1 },
                        new { ID = new Guid("67d09a6f-ce95-498c-bf69-33c7d38f9041"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, Name = "Publisher Portal", PortalKey = "PubPortal", UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), UserType = 2 },
                        new { ID = new Guid("f4952ef3-f1bd-4621-a5f9-290fd09bc81b"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, Name = "Business Portal", PortalKey = "BizPortal", UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), UserType = 3 },
            ...
            modelBuilder.Entity("ewApps.AppPortal.Entity.PortalAppLinking", b =>
                {
                    ...
                    b.HasData(
                        new { ID = new Guid("8bfbd8af-5f27-4eb9-a508-be87a84c7963"), AppId = new Guid("5a066e57-73c2-4fae-a7bb-0be3abdfb35c"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, PortalId = new Guid("8ded3502-01e5-469a-909b-5424d50d00d6"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc) },
                        new { ID = new Guid("7c9a4607-9410-4e61-b4ab-f1d8df7305cc"), AppId = new Guid("0ac1701b-3d90-454c-80a9-7cf062109795"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, PortalId = new Guid("67d09a6f-ce95-498c-bf69-33c7d38f9041"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc) },
                        new { ID = new Guid("0a826d78-14af-469f-8f78-9a7b068c574c"), AppId = new Guid("31127b13-5be1-48b5-aa85-93a28682ef20"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, PortalId = new Guid("f4952ef3-f1bd-4621-a5f9-290fd09bc81b"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc) },
                        new { ID = new Guid("7a128e85-c2e2-4650-85bd-cc433a4e532e"), AppId = new Guid("8c6fa8ce-6b94-428f-95de-5ed8859260d2"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, PortalId = new Guid("f4952ef3-f1bd-4621-a5f9-290fd09bc81b"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc) },
                        new { ID = new Guid("caf59a3e-fb1e-4fb9-8129-9383230477bb"), AppId = new Guid("6118a7ff-742b-25db-a9c1-8e252c39bb73"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, PortalId = new Guid("f4952ef3-f1bd-4621-a5f9-290fd09bc81b"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc) },
                        new { ID = new Guid("a4e51eea-81dc-4345-b9b1-76262b5c4f0e"), AppId = new Guid("2b031b59-5276-589c-9d75-2a7ae1c799c8"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, PortalId = new Guid("f4952ef3-f1bd-4621-a5f9-290fd09bc81b"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc) },
