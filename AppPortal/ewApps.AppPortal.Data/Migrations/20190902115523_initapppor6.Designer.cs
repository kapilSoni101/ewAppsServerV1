...
namespace ewApps.AppPortal.Data.Migrations
{
    ...
    [Migration("20190902115523_initapppor6")]
    partial class initapppor6
    {
            ...
            modelBuilder.Entity("ewApps.AppPortal.Entity.RoleLinking", b =>
                {
                    ...
                    b.HasData(
                        new { ID = new Guid("0b03bbe7-b3f7-4978-9411-2b9cb8976579"), AppId = new Guid("8ded3502-01e5-469a-909b-5424d50d00d6"), CreatedBy = new Guid("4278d1fc-2bac-4c2c-be0c-25955d87733e"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, RoleId = new Guid("df435b1a-7dbd-4e8f-b0f9-c07ba6e84f80"), TenantId = new Guid("18571765-24b5-4c36-a957-416eaec38fda"), TenantUserId = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedBy = new Guid("0808036c-16ef-4fe4-89be-641285b9028a"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc) }
                    );
                });
