...
namespace ewApps.AppPortal.Data.Migrations
{
    ...
    [Migration("20191107104007_appfavoritemaster")]
    partial class appfavoritemaster
    {
            ...
            modelBuilder.Entity("ewApps.AppPortal.Entity.Favorite", b =>
                {
                    ...
                    b.HasData(
                        new { ID = new Guid("eeec0c47-9c5e-4bde-914b-39a3e3a387ee"), AppId = new Guid("2b031b59-5276-589c-9d75-2a7ae1c799c8"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Transaction History", PortalKey = "pay", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "transaction/ history" },
                        ...
                        new { ID = new Guid("4a5519b6-e2c9-42e2-9715-cae5af638b15"), AppId = new Guid("8c6fa8ce-6b94-428f-95de-5ed8859260d2"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Transaction History", PortalKey = "pay", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "transaction/ history" },
                        new { ID = new Guid("8120877e-3351-4f1b-924e-9934551f176e"), AppId = new Guid("8c6fa8ce-6b94-428f-95de-5ed8859260d2"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Receive Payment", PortalKey = "pay", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "arinvoices" },
                        new { ID = new Guid("c4285a44-32e9-4c4a-b186-843b6c31b4fb"), AppId = new Guid("8c6fa8ce-6b94-428f-95de-5ed8859260d2"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Refund", PortalKey = "transaction/ refund", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "arinvoices" },
                        new { ID = new Guid("4e5a3aa9-86bc-4dea-9acf-136678ef8cfe"), AppId = new Guid("8c6fa8ce-6b94-428f-95de-5ed8859260d2"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Void a Payment", PortalKey = "pay", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "transaction/ void" },
                        new { ID = new Guid("fcd4ccc7-eeba-49de-a1aa-83f1cd57a3e8"), AppId = new Guid("2b031b59-5276-589c-9d75-2a7ae1c799c8"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Transaction History", PortalKey = "cust", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "payment/ history" },
                        new { ID = new Guid("98f338c6-fada-4c44-8f09-298f4c6cc292"), AppId = new Guid("2b031b59-5276-589c-9d75-2a7ae1c799c8"), CreatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), CreatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Deleted = false, MenuKey = "Make a Payment", PortalKey = "cust", System = true, TenantId = new Guid("00000000-0000-0000-0000-000000000000"), TenantUserId = new Guid("00000000-0000-0000-0000-000000000000"), UpdatedBy = new Guid("54b675f2-afdf-400f-a4fe-335ca6adbc40"), UpdatedOn = new DateTime(2019, 2, 4, 9, 40, 36, 503, DateTimeKind.Utc), Url = "payment" },
