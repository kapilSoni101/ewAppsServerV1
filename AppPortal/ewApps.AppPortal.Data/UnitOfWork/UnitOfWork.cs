...
namespace ewApps.AppPortal.Data {
  ...
  public class UnitOfWork:IUnitOfWork {
    ...
    private readonly AppPortalDbContext _appPortaldbContext;
    ...
    public UnitOfWork(AppPortalDbContext appPortaldbContext, bool disableSaveChanges= false) {
      _appPortaldbContext = appPortaldbContext;
    ...
    public void Save() {
      if(_disableSaveChanges == false) {
        _appPortaldbContext.SaveChanges();
      }
    }
    ...
    public async Task SaveAsync() {
      if(_disableSaveChanges == false) {
        await _appPortaldbContext.SaveChangesAsync();
      }
    }
