...
namespace ewApps.AppPortal.DTO {
    ...
    /// <summary>
    /// Platform application Inactive message.
    /// </summary>
    public string PlatAppInactiveComment {
      get;
      set;
    }

    /// <summary>
    ///  Publisher application Inactive message.
    /// </summary>
    public string PubAppInactiveComment {
      get;
      set;
    }
    /// <summary>
    /// Platform Application Active/Inactive
    /// </summary>
    public bool PlatAppActive {
      get; set;
    }
    /// <summary>
    /// Publisher Application Active/Inactive
    /// </summary>
    public bool PubAppActive {
      get; set;
    }
