...
namespace ewApps.AppPortal.DTO {
    ...
    /// 
    /// </summary>
    public class BusBAContractItemDTO {
        ...
        /// 
        /// </summary>
        public int CummlativeCommittedQuantity {
            get; set;
        }

        public decimal CummlativeCommittedAmount {
            get; set;
        }

        public int CummlativeQuantity {
            get; set;
        }

        public decimal CummlativeAmountLC {
            get; set;
        }
