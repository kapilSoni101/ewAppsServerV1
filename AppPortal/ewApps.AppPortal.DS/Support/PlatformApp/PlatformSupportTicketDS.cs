...
//  public class PlatformSupportTicketDS:SupportTicketDS, IPlatformSupportTicketDS {
...
//    public PlatformSupportTicketDS(IIdentityDS identityDS, IUserSessionManager userSessionDS, ITenantUserDS appUserDS,
//      ISupportTicketDS supportTicketDS, ISupportCommentDS supportCommentDS, ILevelTransitionHistoryDS levelTransitionDS,
...
//, ISupportTicketAssigneeHelper supportTicketAssigneeHelper, ISupportTicketRepository supportTicketRepository)
...
//      _appKey = AppKeyEnum.plat.ToString();
...
//      return new SupportApp() { ApplicationKey = AppKeyEnum.plat.ToString(), ApplicationName = AppKeyEnum.plat.ToString() };
//    }
...
//    ///<inheritdoc/>
//    public new bool UpdatePlatformSupportTicket(SupportAddUpdateDTO supportTicketDTO, SupportLevelEnum supportLevel) {
//            //// Get ticket entity.
...
//            //string oldSupportLevel = _supportTicketAssigneeHelper.GetPlatformAssignedToName(supportTicketOld.CurrentLevel, supportTicketDTO.TenantId, supportTicketOld.CreatedBy);
//            //string newSupportLevel = _supportTicketAssigneeHelper.GetPlatformAssignedToName(supportTicketDTO.CurrentLevel, supportTicketDTO.TenantId, supportTicketOld.CreatedBy);
...
//    //}
//    /// <inheritdoc/>
//    public SupportTicketDetailDTO GetLevel4SupportTicketDetailById(Guid supportId, bool includeDeleted) {
//      SupportSession supportSession = GetSession(AppKeyEnum.plat.ToString());
...
//    public List<SupportTicketDTO> GetLevel2TicketList(Guid tenantId, bool onlyDeleted) {
//      // Get all support ticket by Application Id and Tenant Id and GenerationLevel=1
//      return _supportTicketDS.GetLevel2TicketList(AppKeyEnum.pay.ToString(), tenantId, onlyDeleted);
//    }
