...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!--Subject – <Publisher Name> Company Portal - <application>: Ticket <Ticket ID> received new attachment.

Dear <Created By>,

Ticket <Ticket ID> received <count> new attachment from <Modified By> on <Modified On>. Below are the basic details of the ticket:
...
Please click on the below link to view details:
...
<Publisher Name> Team.-->
  ...
  <xsl:param name="attachmentCount"/>
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> received new attachment. </xsl:text>
        </title>
        <style type="text/css">
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:value-of select="$attachmentCount"/>
            ...
            <td valign="top" align="center" class="textContent">
              <div style="text-align:left;font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px;margin-bottom:0;color:#000;line-height:19px;">
                ...
                <p style="font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px; color:#000;">
                  ...
                  <xsl:choose>
                    <xsl:when test="$attachmentCount = '1'">
                      <xsl:text> attachment from </xsl:text>
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:text> attachments from </xsl:text>
                    </xsl:otherwise>
                  </xsl:choose>
                  <xsl:value-of select="$modifiedBy"/>
                  <xsl:text> on </xsl:text>
