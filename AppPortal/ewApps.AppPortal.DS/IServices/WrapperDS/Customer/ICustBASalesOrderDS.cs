...
namespace ewApps.AppPortal.DS {
    ...
    public interface ICustBASalesOrderDS {
        ...
        Task AddSalesOrderWithItemAsync(CustBASalesOrderAddDTO dto, CancellationToken cancellationToken = default(CancellationToken));

        Task UpdateSalesOrderWithItemAsync(CustBASalesOrderUpdateDTO dto, CancellationToken cancellationToken = default(CancellationToken));
    }
}
