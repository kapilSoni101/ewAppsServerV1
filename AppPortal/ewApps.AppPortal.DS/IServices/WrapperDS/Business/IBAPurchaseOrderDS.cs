...
namespace ewApps.AppPortal.DS {
    ...
    /// </summary>
    public interface IBAPurchaseOrderDS {
        /// <summary>
        ...
        Task<IEnumerable<BAPurchaseOrderDTO>> GetPurchaseOrderListByBusinessTenantIdAsync(Guid businessTenantId,ListDateFilterDTO listDateFilterDTO, CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<BAPurchaseOrderViewDTO> GetPurchaseOrderDetailByPOIdAsync(Guid businessTenantId, Guid soId, CancellationToken cancellationToken = default(CancellationToken));
    }
}
