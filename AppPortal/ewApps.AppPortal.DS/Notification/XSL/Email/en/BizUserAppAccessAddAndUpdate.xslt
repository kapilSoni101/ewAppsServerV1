...
Business User <New User> application(s) access has been updated by <Updated By> on <date & time> for below applications. 
                ...
                <div style="font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px;color:#000;">
                  ...
                  <div>
                    <table border="1" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <xsl:for-each select="ArrayOfAppShortInfoDTO/AppShortInfoDTO">
