...
Subject – <Publisher Co. Name> Business Portal: Your <App Name> application access is withdrawn. 

Dear <Business User Name>,  

Your access to <App Name> application is withdrawn on <Publisher Co. Name> Business Portal on <date & time>.  Please contact your Portal Admin for details. 
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Business Portal: Your </xsl:text>
          <xsl:text> </xsl:text>
