...
<!--Subject – <Publisher Co. Name> Publisher Portal: Link to reset your password.

Dear <Publisher User Name>,

We have been informed that you have forgot the password for username: <Publisher user email id>. The below link will reset the password in all the accounts associated with same email id.
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text>  Publisher Portal: Link to reset your password. </xsl:text>
        </title>
        <style type="text/css">
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="$publisherUserEmailId"/>
