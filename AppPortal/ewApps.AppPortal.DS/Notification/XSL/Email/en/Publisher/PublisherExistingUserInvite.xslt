...
<!--Subject – <Publisher Co. Name> Publisher Portal: You have an invitation from <Publisher Co. Name>.

Dear <Invited User Name>,

<Publisher Inviting User Name> hereby invites you to join <Publisher Co. Name> Publisher Portal. It seems that this email id <email id> already exists on <portal name on which set password done>, please use the existing credentials for login.
