...
Subject – <Publisher Co. Name> Customer Portal: Link to reset your password. 

Dear <Customer User Name>, 

We have been informed that you have forgot the password for username: <Customer user email id>. The below link will reset the password in all the accounts associated with same email id.

Please click on the below link to reset your password: Click Here
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Customer Portal: Link to reset your password.</xsl:text>
        </title>
        <style type="text/css">
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:value-of select="$customerUserID"/>
