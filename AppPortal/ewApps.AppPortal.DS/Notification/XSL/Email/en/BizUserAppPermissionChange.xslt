...
Subject – <Publisher Co. Name> Business Portal: Your permissions for <customer portal> application is updated. 

Dear <Business User Name>,

<Business User Name who made the change> has updated your access permissions for <Customer Portal> application. 
To view your new permissions, login to the <Customer Portal> application. 
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Business Portal: Your permissions for </xsl:text>
          <xsl:text> </xsl:text>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text>, </xsl:text>
                  <xsl:value-of select="$userNameChange"/>
                  <xsl:text> </xsl:text>
            ...
            <td valign="top" align="center" class="textContent">
              <div style="text-align:left;font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px;margin-bottom:0;color:#000;line-height:19px;">
                ...
                <p style="font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px; color:#000;">
                  ...
                  <xsl:text> </xsl:text>
                  <xsl:text> your access permissions for </xsl:text>
                  <xsl:text> </xsl:text>
                  <b>
                    <xsl:value-of select="$applicationName"/>
                  </b>
