...
<!--Subject – <Publisher Co. Name> Business Portal: New Customer Ticket <Ticket ID> of <Customer Co. Name> user for <Payment> application is received.

Dear <Business Co. Name>, 

A new Customer Ticket <Ticket ID> of <Customer Co. Name> user for <Payment> application with below details received. 
Customer ID: 
Customer Name: 
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Business Portal: New Customer Ticket </xsl:text>
          <xsl:text> </xsl:text>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text> A new Customer Ticket </xsl:text>
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="$ticketID"/>
                  <xsl:text> </xsl:text>
                  <xsl:text> of </xsl:text>
