...
Subject – <Publisher Co. Name> Business Portal: New user is onboard <Customer Portal> application. 

Dear <Business Co. Name>, 

You have a new user <New User> onboard <Customer Portal> application on <Publisher Co. Name> Business Portal on <date & time>. 
