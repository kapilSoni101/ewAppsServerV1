...
Subject – <Publisher Co. Name> Customer Portal: New user is onboard <Customer Portal> application.

Dear <Customer Co. Name>, 

You have a new user <New User> onboard <Customer Portal> application on <Publisher Co. Name> Customer Portal on <date & time>. 
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> Customer Portal: New user is onboard </xsl:text>
          <xsl:text> </xsl:text>
