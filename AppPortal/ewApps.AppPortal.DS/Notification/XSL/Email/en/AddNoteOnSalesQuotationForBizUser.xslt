...
<!--
Subject – <Publisher Co. Name> Business Portal: New Note added in Sales Quotation <ID> of <Customer Co. Name>. 

Dear <Business Co. Name>,

A new Note is added in Sales Quotation <ID> with below details on <date and time>. 
Sales Quotation ID: <ID> 
Customer Name: <Business Partner Co. Name> 
Customer ID: < Business Partner Co. ID> 
Added By User Type: <Invoice ID>. 
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Business Portal: New Note added in Sales Quotation </xsl:text>
          <xsl:text> </xsl:text>
