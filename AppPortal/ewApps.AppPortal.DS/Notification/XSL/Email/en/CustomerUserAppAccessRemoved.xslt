...
<!--Subject – <Publisher Co. Name> Customer Portal: Your <Payment> application access is withdrawn. 

Dear <Customer payment User Name>, 

Your access to <Payment> application is withdrawn on <Publisher Co. Name> Customer Portal on <date & time>. Please contact your Portal Admin for details.
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Customer Portal: Your </xsl:text>
          <xsl:text> </xsl:text>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:value-of select="$publisherCompanyName"/>
                  <xsl:text> </xsl:text>
                  <xsl:text> Customer Portal on </xsl:text>
                  <xsl:text> </xsl:text>
