...
<!--Subject – <Platform Co. Name> Platform Portal: Link to reset your password.

Dear <Platform User Name>,

We have been informed that you have forgot the password for username: <Platform user email id>. The below link will reset the password in all the accounts associated with same email id.
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:param name="platformUserEmailId"/>
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Platform Portal: Link to reset your password.</xsl:text>
        </title>
        <style type="text/css">
