...
Subject – <Publisher Co. Name> Customer Portal: New Note added in Draft Delivery <ID>. 

Dear <Customer Co. Name>,

A new Note is added in Draft Delivery <ID> with below details on <date and time>.
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Customer Portal: New Note added in Draft Delivery </xsl:text>
          <xsl:text> </xsl:text>
