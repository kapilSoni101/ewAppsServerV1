...
Subject – <Publisher Co. Name> Customer Portal: New Note added in A/P Invoice <ID>. 

Dear <Customer Co. Name>, 

A new Note is added in A/P Invoice <ID> with below details on <date and time>. 
...
<Copyright text set at the Publisher> You received this email because you are subscribed to Portal Alerts from <Business
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Customer Portal: New Note added in A/P Invoice </xsl:text>
          <xsl:text> </xsl:text>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text>, </xsl:text>             
                  <xsl:text> A new Note is added in A/P Invoice </xsl:text>
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="$invoiceID"/>
                  <xsl:text> </xsl:text>
            ...
            <td valign="top" align="center" class="textContent">
              <div style="text-align:left;font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px;margin-bottom:0;color:#000;line-height:19px;">
                ...
                <p style="font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px; color:#000;">
                  ...
                  <xsl:text> in A/P Invoice </xsl:text>
                  <b>
                    <xsl:value-of select="$invoiceID"/>
                  </b>
                  <xsl:text> </xsl:text>
