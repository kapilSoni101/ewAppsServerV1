...
<Business Co. Name> hereby invites you to create <Business Partner Co. Name> company account on <Publisher Co. Name> <Business Partner Type> Portal - <Application Name>. It seems that this email id <email id> already exists on <portal name on which set password done>, please use the existing credentials for login. 
