    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Vendor Portal: Link to reset your password.</xsl:text>
        </title>
        <style type="text/css">
...
Subject – <Platform/Publisher Co. Name> <Portal Type> Portal: Link to reset your password.  
 
Dear <User Name>,  
 
We have been informed that you have forgot the password for username: <portal type user email id>. The below link will reset the password in all the accounts associated with same email id. 
...
<Platform/Publisher Co. Name>   
                                                       ...
                                                       <Copyright text set at the Platform/Publisher>
