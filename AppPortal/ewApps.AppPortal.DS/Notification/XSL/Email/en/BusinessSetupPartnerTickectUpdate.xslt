...
Subject - <Publisher Co. Name> Business Portal: Existing <Business Partner Type> Ticket <Ticket ID> of <BP Co. Name> user for <Application Name> is updated. 

Dear <Business Co. Name>, 

Existing <Business Partner Type> Ticket <Ticket ID> of <BP Co. Name> user for <Application Name> application 
is updated by < Modified By> on <Modified On> for: 
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Business Portal: Existing </xsl:text>
          <xsl:text> </xsl:text>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text> New. Below are the basic details of the ticket: </xsl:text>
