...
Subject – <Publisher Co. Name> Business Portal: New <Business Partner Type> Ticket <Ticket ID> of <BP Co. Name> user for <Application Name> received. 

Dear <Business Co. Name>, 
A new <Business Partner Type> Ticket <Ticket ID> for <Application Name> application with below details received. 

<Business Partner Type> ID: 
<Business Partner Type> Name: 
...
Attachment(s): <count> Please login to the portal to view more details. 

Your portal details are as below: Sub Domain: <Sub domain> Portal URL: <Business Portal URL>
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Business Portal: New </xsl:text>
          <xsl:text> </xsl:text>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> application is received.</xsl:text>
        </title>
        <style type="text/css">
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:value-of select="$applicationName"/>
                  <xsl:text> </xsl:text>
                  <xsl:text> application with below details received</xsl:text>
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="$bpType"/>
