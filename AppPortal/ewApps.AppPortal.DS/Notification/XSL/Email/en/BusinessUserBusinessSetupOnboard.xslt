...
<!--Subject – <Publisher Co.="" Name="">  Business Portal: New user is onboard. 

Dear <Business Co.="" Name="">, You have a new user <New User=""> onboard on <Publisher Co.="" Name="">
Business Portal on <date & time>. 

Application(s) access given for: 
1. <Application Name="" based="" on="" the="" access="" given="">
2. < Application Name based on the access given > Please login to the portal to view more details. Your portal details are as below: Sub Domain: <Sub domain="">
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/">
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <!--<xsl:text>. Application(s) access given for: </xsl:text>
                  <xsl:text> </xsl:text>
                  <xsl:text>1. </xsl:text>
    ...
    </html>C:\ewAppsServices\ewAppsServerV1\AppPortal\ewApps.AppPortal.DS\Notification\XSL\Email\en\BizCustAppPermissionChanged.xslt
  </xsl:template>
</xsl:stylesheet>