...
Subject - <Publisher Co. Name> Customer Portal: My Ticket <Ticket ID> of <Customer Portal> application is updated. 

Dear <Customer User Name>,

My Ticket <Ticket ID> of <Customer Portal> application is updated by <updated by> on <Modified On> for: 
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text> attachments. NOTE – Add Attachments to the email, if any. Below are the basic details of the ticket: </xsl:text>                  
            ...
            <td valign="top" align="center" class="textContent">
              <div style="text-align:left;font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px;margin-bottom:0;color:#000;line-height:19px;">
                ...
                <p style="font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px; color:#000;">
                  ...
                  <xsl:value-of select="$count"/>
                  <xsl:text> </xsl:text>
                  <xsl:text> attachments. NOTE – Add Attachments to the email, if any.</xsl:text>
                </p>
