...
<!--Subject – <Publisher Co. Name> Publisher Portal: <Business Co Name> company account is deleted.

Dear <Publisher Co. Name>,

< Publisher User Name who made the change > has deleted <Business Co. Name> company account on <Publisher Co. Name> Business Portal.
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> company account is deleted.</xsl:text>
        </title>
        <style type="text/css">
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:value-of select="$publisherCompanyName"/>
                  <xsl:text>, </xsl:text>
                  <xsl:value-of select="$publisherUserChanged"/>
                  <xsl:text> </xsl:text>
