...
Subject – <Publisher Co. Name> Business Portal: New Note added in Sales Order <ID> of <Customer Co. Name>. 

Dear <Business Co. Name>, A new Note is added in Sales Order <ID> with below details on <date and time>. 
...
Added By User Type: <User type>. Added By User Name: <User name> New Comment: <Comment> 

Please login to the portal to view more details. 

Your portal details are as below: 
Sub Domain: <Sub domain> 
Portal URL: <Business Portal – Customer Portal URL> 

Regards <Publisher Co. Name>

(<Customer Portal> Application) <Copyright text set at the Publisher> You received this email because you are subscribed 
to Portal Alerts from <Business Co. Name>. Update your email preferences to choose the types of emails you receive.
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Business Portal: New Note added in Sales Order </xsl:text>
          <xsl:text> </xsl:text>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text> A new Note is added in Sales Order </xsl:text>
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="$ID"/>
                  <xsl:text> </xsl:text>
            ...
            <td valign="top" align="center" class="textContent">
              <div style="text-align:left;font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px;margin-bottom:0;color:#000;line-height:19px;">
                ...
                <p style="font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px; color:#000;">
                  ...
                  <xsl:text> in Sales Order </xsl:text>
                  <b>
                    <xsl:value-of select="$ID"/>
                  </b>
                  <xsl:text> </xsl:text>
