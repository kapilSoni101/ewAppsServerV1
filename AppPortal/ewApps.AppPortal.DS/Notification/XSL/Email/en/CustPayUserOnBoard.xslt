...
<!--Subject – <Publisher Co. Name> Customer Portal: New user is onboard <Payment> application.

Dear <Customer Co. Name>, 

You have a new user <New User> onboard <Payment> application on <Publisher Co. Name> Customer Portal on <date & time>. 
