...
<!--Subject – <Publisher Co. Name> Business Portal: <Application Name> application is <status> now.

Dear <Business Co. Name>,

<Application name> application on <Publisher Co. Name> Business Portal is <status> now. You can contact <Publisher Co. Name> for more details.
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:value-of select="$publisherCompanyName"/>
                  <xsl:text> </xsl:text>                 
                  <xsl:text> Business Portal is</xsl:text>
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="$status"/>
                  <xsl:text> now. You can contact </xsl:text>
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="$publisherCompanyName"/>
                  <xsl:text> </xsl:text>
                  <xsl:text> for more details.</xsl:text>
                  <xsl:text> </xsl:text>
                  <xsl:text>Administrator Message: </xsl:text>
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="$administratorMessage"/>
                  <xsl:text> </xsl:text>
