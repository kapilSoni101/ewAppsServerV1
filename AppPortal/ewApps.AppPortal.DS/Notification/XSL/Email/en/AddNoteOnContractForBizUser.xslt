...
Subject – <Publisher Co. Name> Business Portal: New Note added in Contract <ID> of <Customer Co. Name>.

Dear <Business Co. Name>,

A new Note is added in Contract <ID> with below details on <date and time>. 
...
You received this email because you are subscribed to Portal Alerts from <Business Co. Name>. Update your email preferences to choose the types of emails you receive.
-->
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Business Portal: New Note added in Contract </xsl:text>
          <xsl:text> </xsl:text>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text> A new Note is added in Contract </xsl:text>
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="$ID"/>
                  <xsl:text> </xsl:text>
