...
<!--Subject – <Publisher Co. Name> <Business Partner type> Portal: Company account is deleted.

Dear <Business Partner Co. Name>,

<Business Co. Name> company account on <Publisher Co. Name> <Portal Type> Portal has been deleted. You can contact <Business Co. Name> for more details.
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Portal: Company account is deleted.</xsl:text>
        </title>
        <style type="text/css">
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">                 
                  ...
                  <xsl:text> </xsl:text>
                  <xsl:text>  Portal has been deleted. You can contact </xsl:text>
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="$businessCompanyName"/>
                  <xsl:text> </xsl:text>
            ...
            <td valign="top" align="center" class="textContent">
              <div style="text-align:left;font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px;margin-bottom:0;color:#000;line-height:19px;">
                ...
                <p style="font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px; color:#000;">
                  ...
                  <xsl:text>  has been deleted. You can contact </xsl:text>
                  <xsl:text> </xsl:text>
                  <b>
                    <xsl:value-of select="$businessCompanyName"/>
                  </b>
