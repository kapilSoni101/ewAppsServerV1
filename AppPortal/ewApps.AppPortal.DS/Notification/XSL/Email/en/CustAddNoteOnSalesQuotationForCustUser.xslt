...
Subject – <Publisher Co. Name> Business Portal: New Note added in Sales Quotation <ID>. 

Dear <Customer Co. Name>, A new Note is added in Sales Quotation <ID> with below details on <date and time>. 

Sales Quotation ID: <ID> Added By User Type: <User Type> Added By User Name: <User name> New Comment: <Comment> 
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> Customer Portal: New Note added in Sales Quotation </xsl:text>
          <xsl:text> </xsl:text>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text> A new Note is added in Sales Quotation </xsl:text>
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="$ID"/>
                  <xsl:text> </xsl:text>
            ...
            <td valign="top" align="center" class="textContent">
              <div style="text-align:left;font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px;margin-bottom:0;color:#000;line-height:19px;">
                ...
                <p style="font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px; color:#000;">
                  ...
                  <xsl:text> in Sales Quotation </xsl:text>
                  <b>
                    <xsl:value-of select="$ID"/>
                  </b>
                  <xsl:text> </xsl:text>
