...
<!--Subject - <Publisher Co. Name> Business Portal: Customer Ticket <Ticket ID> of <Customer Portal> application is updated. 

Dear <Business Co. Name>, 

Customer Ticket <Ticket ID> of <Customer Portal> application is updated by < Modified By> on <Modified On> for: 
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text>, </xsl:text>               
                  <xsl:text> Customer Ticket </xsl:text>
                  <xsl:value-of select="$ticketID"/>
                  <xsl:text> </xsl:text>
                  <xsl:text> of </xsl:text>                  
                  <xsl:text> </xsl:text>
...
<xsl:if test="not(newAssignedTo = $newAssignedTo)">                   
...
<xsl:if test="($commentsText != '')">
 ...
 <xsl:if test="count &gt;  0">
                  ...
                  <xsl:text>attachments.Below are the basic details of the ticket: Customer ID: </xsl:text>
                  <xsl:text> </xsl:text>
