...
<!--Subject - <Publisher Co. Name> Business Portal: You have an invitation from <Business Co. Name>.

Dear <Invited User>, 

<Business Inviting User Name> hereby invites you to join <Publisher Co. Name> Business Portal. It seems that this email id <email id> already exists on <portal name on which set password done>, please use the existing credentials for login.
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:param name="businessUserInviteSetPwd"/>
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:value-of select="$businessInvitingUserName"/>
                  <xsl:text> hereby invites you to join </xsl:text>
                  <xsl:value-of select="$publisherCompanyName"/>
                  <xsl:text> </xsl:text>
                  <xsl:text> Business Portal. It seems that this email id </xsl:text>                
                  <xsl:text> </xsl:text>
                  ...
                  <xsl:value-of select="$businessUserInviteSetPwd"/>
