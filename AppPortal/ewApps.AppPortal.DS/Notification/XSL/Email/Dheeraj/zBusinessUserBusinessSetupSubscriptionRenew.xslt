...
is renewed. Dear <Business Co.="" Name="">
,
Existing subscription plan <Plan Name="">
with below details for <Application Name="">
is renewed. New Start Date: New Expiry Date/ Auto Renewal Date: Auto Renewal: Please login to the portal to view more details. Your portal details are as below: Sub Domain: <Sub domain="">
