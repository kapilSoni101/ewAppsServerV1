...
<!--Subect – <Publisher Co. Name> Business Portal: Application <Application Name> access updated for <Count> 
<Business Partner Type> and <Count> Business Users. 

Dear <Business Co. Name>, 

Application <Application Name> access updated for <Count> <Business Partner Type> 
and <Count> Business Users by <updated by> on <date & time>. 

New <Business Partner Type> with app access: <Count> 
1. <BP Co. Name 1> 
2. <BP Co. Name 2> 

<Business Partner Type> with access removed: <Count> 
1. <BP Co. Name 1> 
2. <BP Co. Name 2> 

New Business Users with app access: <Count> 
1. <Business User Name 1>
2. < Business User Name 2>

Business Users with access removed: <Count> 
1. <Business User Name 1> 
2. < Business User Name 2> 
    ...
    <html>
      <head>
        <title>
          ...
          <xsl:text> </xsl:text>
          <xsl:text> application access is withdrawn. </xsl:text>
        </title>
        <style type="text/css">
           ...
           opacity:0;height:0px;
            ...
            <div>
             ...
             position: absolute;">
                  ...
                  <xsl:text> Your access to</xsl:text>
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="$applicationName"/>
                  <xsl:text> </xsl:text>
                  <xsl:text> application is withdrawn on </xsl:text>
                  <xsl:text> </xsl:text>
                  <xsl:value-of select="$publisherCompanyName"/>
                  <xsl:text> </xsl:text>
                  <xsl:text> Business Portal. Please contact your Portal Admin for details.</xsl:text>
            ...
            <td valign="top" align="center" class="textContent">
              <div style="text-align:left;font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px;margin-bottom:0;color:#000;line-height:19px;">
                ...
                <p style="font-family:'Lucida Sans Unicode','Lucida Grande', sans-serif;font-size:14px; color:#000;">
                  ...
                  <xsl:text>. Please contact your Portal Admin for details. </xsl:text>
                </p>
