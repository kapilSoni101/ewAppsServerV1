...
namespace ewApps.AppPortal.DS {
    ...
    public class PublisherAccess:PublisherEntityAccess, IPublisherAccess {

        PlatformUserPlatformAppPermissionEnum permEnum;

        public PublisherAccess(IUserSessionManager sessionManager, IRoleDS roleDS) : base(sessionManager, roleDS) {
        }

        public override bool[] AccessList(Guid entityId) {
            bool[] accessVector = new bool[1];
            accessVector[0] = CheckAccess((int)PlatformUserPlatformAppPermissionEnum.ManagePublishers, Guid.Empty);
        ...
        public override bool CheckAccess(int operation, Guid entityId) {
            ...
            switch(operation) {
                ...
                case (int)OperationType.Delete:
                    hasPermission = (bitmask & PlatformUserPlatformAppPermissionEnum.ManagePublishers) == PlatformUserPlatformAppPermissionEnum.ManagePublishers;
                    break;
            }
