...
namespace ewApps.AppPortal.DS {
    ...
    public CustBADeliveryDS(IUserSessionManager userSessionManager, IOptions<AppPortalAppSettings> options, INotesDS notesDS) {
        ...
        public async Task<IEnumerable<CustBADeliveryDTO>> GetDeliveryListByBusinessTenantIdAsyncForCust(Guid businessTenantId,ListDateFilterDTO listDateFilterDTO, CancellationToken cancellationToken) {
            string url = string.Format("custbadelivery/list/{0}", businessTenantId);
            ...
            return await httpRequestProcessor.ExecuteAsync<IEnumerable<CustBADeliveryDTO>>(requestOptions, false);
        }
      ...
      string url = string.Format("custbadelivery/view/{0}/{1}", businessTenantId, deliveryId);
            ...
            CustBADeliveryViewDTO dto = await httpRequestProcessor.ExecuteAsync<CustBADeliveryViewDTO>(requestOptions, false);
