...
namespace ewApps.AppPortal.DS {
    public class PubTenantUserDeleteDS :IPubTenantUserDeleteDS {

        IQPublisherAndUserDS _qPublisherAndUserDS;
        AppPortalAppSettings _appPortalAppSettings;
        IUserSessionManager _userSessionManager;

        public PubTenantUserDeleteDS(IQPublisherAndUserDS qPublisherAndUserDS, IOptions<AppPortalAppSettings> appPortalAppSettings,
        ...
        public async Task<DeleteUserResponseDTO> DeleteTenantUser(TenantUserIdentificationDTO tenantUserIdentificationDTO) {
            ...
            await ValidationOnDeleteUser(tenantUserIdentificationDTO.TenantUserId, tenantUserIdentificationDTO.TenantId, (int)UserTypeEnum.Publisher, tenantUserIdentificationDTO.AppId);

            UserSession userSession = _userSessionManager.GetSession();

            string baseuri = _appPortalAppSettings.AppMgmtApiUrl;
            string requesturl = "tenantuser/deletepublisheruser";
